...
+ параметр, который модулировать/ переключать?
выбирать длительностьсеквенсора
настройки типа АДСР, для всего или только одного уровня

высокий низкий уровень или вообще произвольно


8 секвенсоров для автоматизации всего
туда же LFO

долгое нажатие на первый блок деактивирует, долгое нажатие на первый блок возвращает как было
долгое нажатие на любой другой задает размер секвенции
название блока/параметра текстом на фоне

для эффектов отдельно
выбор какой блок, какой параметр
потом можно будет в круглый скролл добавить назначение в секвенсор по долгому нажатию на кнопку в секвенсор


меню что делать?
скрытые дополнительные параметры?

для пианорола нужно просто тупо 4 строки на осцилятор, с отметками какая нота, и выбор по нажатию клавиатуры
отображение ноты в первой ячейке

нужно вводить bpm и хранить доли
