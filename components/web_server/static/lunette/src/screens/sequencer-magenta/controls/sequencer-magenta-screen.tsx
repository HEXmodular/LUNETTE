...
import { SequencerSelect } from './sequencer-select/sequencer-select';

import { SequencerSelectMenuBlock } from './sequencer-select-menu-block/sequencer-select-menu-block';
...
const SequencerMagentaScreen: React.FC = () => {
...
export default SequencerMagentaScreen;